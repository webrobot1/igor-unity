...
namespace Mmogick
{
	...
	public class EntityModel : MonoBehaviour
	{
		...
		/// <summary>
		/// Направление сущности. Значение ведёт СЕРВЕР — записывается только разбором его пакета: по нему
		/// же различается шаг от телепортации, и запись клиентом этот расчёт сломала бы.
		/// </summary>
