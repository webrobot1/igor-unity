...
namespace Mmogick.VideoRig
{
    ...
    ///
    /// Каталог вывода — параметр: писать пакет умеет только по локальному пути Windows, а рабочий каталог
    /// съёмки живёт на стороне сборщика ролика, куда фрагменты копируются тем же проходом.
    /// </summary>
