...
namespace MyFantasy
{
    public class EventRecive
    {
        ...
        /// <summary>
        /// сколько секуд таймаут события. приходит при загрузке или если в процессе игры изменился на группу события. нужен только для статистики и анимации (тк это максимальное время работы анимации)
        /// </summary>
