...
public class MainController : MonoBehaviour
{
    ...
    protected const string WEBSOCKET_SERVER = "185.117.153.89";
    ...
    //protected const string WEBSOCKET_SERVER = "localhost";          // а для websocket соединений нормально и localhost на wsl
