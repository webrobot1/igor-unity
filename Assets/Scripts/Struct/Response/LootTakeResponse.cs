...
namespace Mmogick
{
    ...
    public class LootTakeResponse : Response
    {
        ...
        // Сколько единиц забрать суммарно по перечисленным позициям; пусто — позиции целиком.
        // Игрок покупает часть стака (десять яблок торговца нужны не всегда), платит ровно за взятое,
